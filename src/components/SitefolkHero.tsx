...
export default function SitefolkHero() {
  return (
    <section className="pt-10 pb-20 md:pt-15 md:pb-32 px-6 md:px-10 max-w-[1280px] mx-auto">
      <div className="flex flex-col items-center text-center">
        {/* Hero Content */}
        <div className="relative w-full max-w-5xl mx-auto">

          {/* Website Icon */}
          <div className="hidden lg:flex absolute left-0 xl:-left-8 top-[35%] -translate-y-1/2 w-16 h-16 items-center justify-center rotate-[-8deg] animate-float">
            <Globe className="w-15 h-15 text-ink" strokeWidth={1.3} />
          </div>

          {/* Ads Icon */}
          <div className="hidden lg:flex absolute right-0 xl:-right-8 top-[65%] -translate-y-1/2 w-16 h-16 items-center justify-center rotate-[8deg] animate-float-delayed">
            <Megaphone className="w-15 h-15" strokeWidth={1.3} />
          </div>
